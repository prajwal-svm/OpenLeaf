---
title: "Installing OpenLeaf"
description: "There are two ways to get OpenLeaf: download a ready-to-run app for your platform, or build it from source. Downloading is the fast path and works for almost ev"
---
...
meant it. Signing is on the [roadmap](https://github.com/prajwal-svm/OpenLeaf/blob/main/README.md#roadmap), and once it ships
this step goes away.
...
- [Getting Started](/OpenLeaf/getting-started/): first project to first PDF in 2 minutes
- [Features](/OpenLeaf/features/): what the editor can do
- [AI Assistant](/OpenLeaf/ai-assistant/): connect a model, or run locally with Ollama
- [Development](https://github.com/prajwal-svm/OpenLeaf/blob/main/docs/development.md): architecture and how to contribute
