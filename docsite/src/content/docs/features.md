---
title: "Features"
description: "What OpenLeaf can do. All of it runs on your machine."
---
...
- Publish to GitHub: create a new repo or link an existing one, then push. See [GitHub Sync](/OpenLeaf/github-sync/).
...
Bring any provider: OpenAI, Anthropic, Groq, OpenRouter, DeepSeek, Mistral, xAI, Z.AI, or run locally with Ollama. See [AI Assistant](/OpenLeaf/ai-assistant/).
