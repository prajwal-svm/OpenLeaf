/** Pure helpers for which PDF pages an agent should inspect after compile. */

/**
 * Pick 1-based page numbers to verify.
 * Always includes first and last (when multi-page); prefers cursor page; fills
 * budget with evenly spaced middle pages. Unique, sorted, length ≤ maxPages.
 */
